            ...
            <div className="header-top d-flex justify-content-between align-items-center">
              <a href="index.html">
                <div className="header-logo">
                  ...
                  <span className="text-primary font-weight-bold bg-white pr-2 pl-1 h2">News</span>
                </div>
              </a>
              <form className="form-group flex-grow-1 mb-0 d-flex">
                <label className="sr-only" htmlFor="exampleFormControlInput1">Email address</label>
